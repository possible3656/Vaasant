package com.winbee.vaasant.helper;
...
public class MyWebChromeClient extends WebChromeClient implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener
{
     ...
     */
    @SuppressWarnings("unused")
    public MyWebChromeClient(View activityNonVideoView, ViewGroup activityVideoView)
    {
     ...
     */
    @SuppressWarnings("unused")
    public MyWebChromeClient(View activityNonVideoView, ViewGroup activityVideoView, View loadingView)
    {
        this.activityNonVideoView = activityNonVideoView;
        this.activityVideoView = activityVideoView;
